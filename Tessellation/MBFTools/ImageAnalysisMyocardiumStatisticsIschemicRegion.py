	...
	def Main(self):
		...
		for LINE in infile:
			...
			for tag in self.Args.TerritoryTag:
				if line[1].find(tag)>=0: TerritoryLabels.append(int(line[0]))
		infile.close()
...
if __name__=="__main__":
	...
	parser.add_argument('-TerritoryTag', '--TerritoryTag', type=str, nargs='+', required=True, dest="TerritoryTag", default="TerritoryTag", help="The territory that will be .")
