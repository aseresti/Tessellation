...
class ImageAnalysisMyocardiumOverlapWithTerritories():
	...
	def Main(self):
		...
		OutputFileName = f"MBFIschemicRegion_cutoff{self.Args.LowerThreshold}.vtu"
		print ("--- Writing the Output File: %s"%self.Args.OutputFolder)
		WriteVTUFile(os.path.join(self.Args.OutputFolder,OutputFileName),Volume)	
...
if __name__=="__main__":
	...
	#parser.add_argument('-OutputFileName', '--OutputFileName', dest='OutputFileName', type=str, required=True)
